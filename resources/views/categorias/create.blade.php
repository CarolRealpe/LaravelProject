...
<main class="container">
    ...
    <form action="{{ route('categorias.store') }}" method="POST">
        ...
        <div class="mb-3">
            ...
            <input type="text" id="nombre" name="nombre" placeholder="Ejemplo: Ensaladas frescas" required>
        </div>

        <div class="mb-3">
            <label for="descripcion">Descripción:</label>
            <textarea id="descripcion" name="descripcion" placeholder="Describe brevemente esta categoría de productos..."></textarea>
        </div>
